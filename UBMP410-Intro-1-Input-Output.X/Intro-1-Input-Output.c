 ...
 * Once Because the time it is released the loop wont be done looping.
 * 2. Explain the difference between the statements: LED3 = 0; and LED3 = 1;
 * When its 0 the light goes off when its 1 the light goes on.
 * 3. What voltage do you expect the microcontroller to output to LED D3 when
 *    the statement LED3 = 0; runs? What voltage do you expect the output to be
 *    when the statement LED3 = 1; runs?
 * when its off its 0 volts and when its on its 5 volts.
 ...
 * One equal sign means its setting a variable to something and two equal signs is comparative
 ...
 * The advantage of using flat c is that its faster and the disandvantage is that it modifies all LEDS.
 ...
 *    made smaller?
 * bigger delay means lower pitch.
 ...
 * The beeper is inverted. its on sometimes and off sometimes.
 ...
 * only one plays at a time because it gets stuck in the loop.
 ...
 * when two or more buttons are being held the buzzer makes a weird noise.
 ...
 *    why it changes?
 * Its dims because sometimes light is on and sometimes light is off.
